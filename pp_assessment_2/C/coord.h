...
#define DEF extern
#endif
#define Nbody 4*1024			/// original_config
//#define Nbody 4*512
...
DEF double *pos[Ndim] __attribute__((aligned(64)));		// no performance
DEF double  *velo[Ndim] __attribute__((aligned(64)));		// no performance

DEF double *f[Ndim], *vis, *mass, *radius;

DEF double *delta_pos[3];
//DEF double delta_pos[3][Ndim*Ndim];
